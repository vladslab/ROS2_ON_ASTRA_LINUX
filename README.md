...
В настоящее время в России многие компании и предприятия переходят на российские операционные системы. Одной из более распространенных является Astra Linux. В центре научно-технического образования в Московском Дворце пионеров мы занимаемся робототехникой и используем ROS2 (Robot Operating System), которая наиболее стабильно работает на Ubuntu. Поэтому, перед нами встала задача по установке ROS2 на компьютеры в нашей лаборатории. 
